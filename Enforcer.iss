...
; for the signing tool put NanolockSafenet as name and
; signtool sign /tr http://timestamp.digicert.com /td sha256 /a /fd sha256 /n "NANOLOCK SECURITY (ISRAEL) LTD"  $p
; for command
#define MyAppName "Nanolock Enforcer"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Nanolock Inc."
#define MyAppURL "https://www.nanolocksecurity.com/"
#define MyAppExeName "NanolockSec.OTDefender.Client.exe"
...
DefaultDirName={autopf}\NanoLock\Enforcer
DisableDirPage=yes
DisableWelcomePage=no
DefaultGroupName=NanoLock
DisableProgramGroupPage=yes
;LicenseFile=LicenseAgreement.rtf
OutputDir=..\Nanolock.OTDefender.Client.Installer
...
VersionInfoProductTextVersion=Nanolock Enforcer

[Messages]
;SetupAppTitle = Setup {#GetRevision()}
;SetupWindowTitle = Setup - {#GetRevision()}
SetupAppTitle = Setup NanoLock OT Defender
SetupWindowTitle = Setup - NanoLock OT Defender
WelcomeLabel2=This will install Nanolock OT Defender on your computer.%n%nIt is recommended that you close all other applications and disable any anti virus before continuing.
...
Source: "..\NanolockSec.OTDefender.Client\bin\release\net6.0-windows\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKA; Subkey: "Software\Microsoft\Windows NT\CurrentVersion\Terminal Server\TSAppAllowList\Applications\NanoLock"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Microsoft\Windows NT\CurrentVersion\Terminal Server\TSAppAllowList\Applications\NanoLock";  ValueType: string; ValueName: "Name"; ValueData: "NanolockSec.OTDefender.Client.exe"
Root: HKA; Subkey: "Software\Microsoft\Windows NT\CurrentVersion\Terminal Server\TSAppAllowList\Applications\NanoLock";  ValueType: string; ValueName: "Path"; ValueData: "{app}"
Root: HKA; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; ValueType: String; ValueName: "{app}\NanolockSec.OTDefender.Client.exe"; ValueData: "RUNASADMIN"; Flags: uninsdeletekeyifempty uninsdeletevalue; 
Root: HKLM; Subkey: "SOFTWARE\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTUser"; ValueData: "NanolockLoc"; Flags: uninsdeletekeyifempty; Check: IsWin64
Root: HKLM; Subkey: "SOFTWARE\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTServer"; ValueData: "OTD-FTSVRDEV"; Flags: uninsdeletekeyifempty; Check: IsWin64
Root: HKLM; Subkey: "SOFTWARE\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTPw"; ValueData: "XBDWvhSyeCSdBN7LUveW+w=="; Flags: uninsdeletekeyifempty; Check: IsWin64
Root: HKLM; Subkey: "SOFTWARE\WOW6432Node\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTUser"; ValueData: "NanolockLoc"; Flags: uninsdeletekeyifempty; Check: not IsWin64
Root: HKLM; Subkey: "SOFTWARE\WOW6432Node\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTServer"; ValueData: "OTD-FTSVRDEV"; Flags: uninsdeletekeyifempty; Check: not IsWin64
Root: HKLM; Subkey: "SOFTWARE\WOW6432Node\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTPw"; ValueData: "XBDWvhSyeCSdBN7LUveW+w=="; Flags: uninsdeletekeyifempty; Check: not IsWin64

;Root: HKLM64; Subkey: "SOFTWARE\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTUser"; ValueData: "NanolockLoc"; Flags: uninsdeletekeyifempty
;Root: HKLM64; Subkey: "SOFTWARE\Nanolock\Enforcer\FactoryTalk\SpecifyFTLocation"; ValueType: string; ValueName: "FTPw"; ValueData: "Nk%Loc$9"; Flags: uninsdeletekeyifempty
...
Filename: "{sys}\sc.exe"; Parameters: "create NanolockWD DisplayName= ""NanolockWD"" binPath= ""{app}\EnforcerWatchdog\Nanolock.EnforcerWatchdog.exe"" start= auto" ; Flags: runhidden; StatusMsg: "Installing service..."   
Filename: "{sys}\sc.exe"; Parameters: "start NanolockWD" ; Flags: runhidden; StatusMsg: "Starting service..." 
...
[UninstallRun]
Filename: {sys}\sc.exe; Parameters: "stop NanolockWD" 
Filename: {sys}\sc.exe; Parameters: "delete NanolockWD" 
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""NanolockSec.OTDefender.Client.exe"""
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""Nanolock.EnforcerWatchdog.exe"""
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""Nanolock.NSA.Host.Process.V15.1.exe"""
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""Nanolock.NSA.Host.Process.V16.exe"""
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""Nanolock.NSA.Host.Process.V17.exe"""
Filename: {sys}\sc.exe; Parameters: "tasklist | findstr /i ""nanolock"" && taskkill /F /IM ""Nanolock.NSA.Host.Process.V18.exe"""
...
begin
  ...
  PrimaryServerPage2 :=
    CreateInputQueryPage(
      ...
      'Enter the domain and IP of the MoT server(ask the NanoLock administrator)', 'MoT Definition');
  PrimaryServerPage2.Add('Subdomain name and domain name (e.g., otd.nanolocksecurity.nl)::', False);
...
begin
  ...
  begin
    ...
    begin
      ...
      // Computer\HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Nanolock\Enforcer\components
      if RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Nanolock\Enforcer\components','rockwell', 1) then
      begin
      ...
      if RegWriteDWordValue(HKEY_LOCAL_MACHINE_32, 'SOFTWARE\Nanolock\Enforcer\components','rockwell', 1) then
      begin
    ...
    begin
      ...
      if RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Nanolock\Enforcer\components','siemens', 1) then
      begin
        //MsgBox('registry created.', mbInformation, MB_OK);
        Log('registry created.');
      end
